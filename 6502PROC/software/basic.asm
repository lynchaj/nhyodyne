...
LAB_20DC
	...
	CMP	#Ram_base_HI		; compare with start of program memory
...
LAB_288B
	...
	BCS	LAB_S28FE		; branch if 1st character numeric
...
BYTEIN:
	JSR	INPVEC			; get byte from simulated ACIA
	CMP	#$FF
...
VEC_IN		= VBTYEIN	; input vector
VEC_OUT		= $FFF0		; output vector
